...
function Dashboard({
  ...
  return (
    <div className=" flex flex-col items-center space-y-4 min-h-screen">
      <h1 className="uppercase font-[750] tracking-[0.2rem] p-5 text-2xl bg-black text-white rounded-xl">
        {repoName}
      </h1>
      <div className="flex flex-col space-y-2 items-center justify-center p-5 w-full ">
        <div className="bg-gray-800 text-white  p-4 rounded-xl flex items-center">
          <ComponentIcon className="mr-2 size-[24px]" />

          <h1 className=" text-lg font-[550]">{description}</h1>
        </div>
        <div className="border border-gray-400 p-2 rounded-xl flex items-center">
          <CompassIcon className="m-2 size-[24px]" />

          <Link
            href={homepage}
            target="_blank"
            className="capitalize hover:animate-pulse  text-lg font-[550]"
          >
      ...
      <div className="flex items-center flex-col md:flex-row justify-evenly p-5 w-full space-y-5">
        ...
        <div className="flex items-center border bg-gray-800 text-white p-2 rounded-xl min-w-[300px] justify-center">
          <Star className="mr-2 size-[24px]" />

          <h1 className=" text-lg font-[550]">{stars}</h1>
        </div>

        <div className="flex items-center border bg-gray-800 text-white p-2 rounded-xl min-w-[300px] justify-center">
          <GitFork className="mr-2 size-[24px]" />

          <h1 className=" text-lg font-[550]">{forks}</h1>
        </div>

        <div className="flex items-center border bg-gray-800 text-white p-2 rounded-xl min-w-[300px] justify-center">
          <UsersIcon className="mr-2 size-[24px]" />

          <h1 className=" text-lg font-[550]">{contributors}</h1>
        </div>

        <div className="flex items-center border bg-gray-800 text-white p-2 rounded-xl min-w-[300px] justify-center">
          <TagIcon className="mr-2 size-[24px]" />

          <h1 className=" text-lg font-[550] truncate max-w-[350px]">
            {latestRelease}
          </h1>
        </div>

        <div className="flex items-center border bg-gray-800 text-white p-2 rounded-xl min-w-[300px] justify-center">
          <CalendarDays className="mr-2 size-[24px]" />
      ...
      <div className="flex flex-col space-y-5 md:flex-row space-x-2 justify-evenly">
        ...
        <div className="space-y-10 flex flex-col border border-gray-400 rounded-xl flex-[0.5] p-1">
          <h1 className="text-center  text-[25px] font-[550] mt-2">
            Languages Used
          </h1>
            ...
            {languages.map((item) => {
              ...
              return (
                <div className="border border-gray-300 p-3 rounded-xl m-2 min-w-[180px] odd:bg-gray-100 even:bg-gray-200">
                  <p className="tracking-[0.1rem] text-[15px] font-[550]">
                    {item.language}
                  </p>
        ...
        <div className="space-y-2 overflow-x-hidden flex flex-col border border-gray-400 p-3 rounded-xl flex-[0.5] max-h-[690px] overflow-y-scroll">
          <h1 className="capitalize text-center  text-[25px] font-[550]">
            latest open PR's
          </h1>
          ...
          <div className="space-y-2 ">
            {issues.map((item) => (
              <Link
                href={item.href}
                className="flex items-center justify-between odd:bg-gray-100 even:bg-gray-200 p-1 mt-5 hover:opacity-60"
              >
      ...
      <div className="flex flex-col md:flex-row space-y-5 items-center justify-evenly space-x-2 w-full">
        ...
        <div className="border border-gray-400 px-1 py-4 rounded-xl flex-[0.5] w-1/2">
          <h1 className="text-center  text-[25px] font-[550] capitalize">
        ...
        <div className="border border-gray-400 p-4 rounded-xl flex-[0.5] w-1/2">
          <h1 className="text-center  text-[25px] font-[550] capitalize">
            Top {topContributors.length} contributors
          </h1>

          <ChartContainer
            config={chartConfigContributor}
      ...
      <AlertDialog>
        <AlertDialogTrigger>
          <Button className="text-lg p-4 w-[250px] bg-red-500 hover:bg-red-700">
            Delete Dashboard
          </Button>
        </AlertDialogTrigger>
        <AlertDialogContent>
          ...
          <AlertDialogFooter>
            <AlertDialogCancel className="text-[20px]">
              Cancel
            </AlertDialogCancel>
            <AlertDialogAction className="text-[20px]" onClick={deleteRepo}>
              Continue
            </AlertDialogAction>
          </AlertDialogFooter>
        </AlertDialogContent>
